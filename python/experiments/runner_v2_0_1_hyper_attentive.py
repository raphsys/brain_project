...
if __name__ == "__main__":
    ...
    # Configuration de ton protocole streaming
    start_spc = 20
    max_spc = 50
    step_spc = 5
    stream_blocks = [start_spc] + list(range(start_spc + step_spc, max_spc + step_spc, step_spc))

    trainer = StreamingTrainerV2(model_arch=[128, 256], bottleneck_dim=64, device=device)
    ...
    print("\n✅ Streaming Hyper-Attentive terminé.")
