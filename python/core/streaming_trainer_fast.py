...
from core.memory_interface_faiss_multi_fast import MemoryInterfaceFAISS_Multi_Fast

class StreamingTrainerFast:
    def __init__(self, model_arch, bottleneck_dim, device):
        ...
        self.memory_interface = MemoryInterfaceFAISS_Multi_Fast(dimension=bottleneck_dim)
